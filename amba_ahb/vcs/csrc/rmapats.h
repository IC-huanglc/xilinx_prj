...
extern "C" {
#endif
void  hs_0_M_0_0__top_simv_daidir (UB  * pcode, vec32  * I1005, U  I914);
void  hs_0_M_0_6__top_simv_daidir (UB  * pcode, scalar  val, U  I890);
void  hs_0_M_0_7__top_simv_daidir (UB  * pcode, vec32  * I1362, U  I890, U  I1372);
void  hs_0_M_0_10__top_simv_daidir (UB  * pcode, vec32  * I1005);
...
void  hs_0_M_6_0__top_simv_daidir (UB  * pcode, vec32  * I1005, U  I914);
void  hs_0_M_7_0__top_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_8_0__top_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_9_0__top_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_10_0__top_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_11_0__top_simv_daidir (UB  * pcode, vec32  * I1005, U  I914);
void  hs_0_M_12_0__top_simv_daidir (UB  * pcode, vec32  * I1005, U  I914);
void  hs_0_M_13_0__top_simv_daidir (UB  * pcode, vec32  * I1005, U  I914);
void  hs_0_M_14_0__top_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_15_0__top_simv_daidir (UB  * pcode, vec32  * I1005, U  I914);
void  hs_0_M_16_0__top_simv_daidir (UB  * pcode, vec32  * I1005, U  I914);
void  hs_0_M_17_0__top_simv_daidir (UB  * pcode, scalar  val);
void  hs_0_M_17_5__top_simv_daidir (UB  * pcode, UB  val);

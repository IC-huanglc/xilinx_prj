...
//commented by huanglc at 20240312
//this is ahb_lite, from one master to 3 slaves(mem_ahb),
//and the master is from bfm_ahb.v and tasks.
...
(
   ...
   assign HREADY = M_HREADY;    //HREADY is to slaves HREADYin in simulation top.v
   /*********************************************************/
   defparam

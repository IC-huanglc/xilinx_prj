...
#
# Generated by export_simulation on Wed Mar 20 15:11:52 CST 2024
#
################################################################################
...
'-reset_run' switch to the './tb_latch.sh' script.

./tb_latch.sh -reset_run
...
./tb_latch.sh -noclean_files

For more information on the script, please type './tb_latch.sh -help'.
